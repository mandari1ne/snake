...
def draw_score(game_state):
    if game_state == "game_on":
        ...
        score_rect = score_text.get_rect(center = (wight // 2, 66))
        ...
        hight_score_text = score_font.render(f"High Score: {high_score}",
                                             True, (255, 255, 255))
        high_score_rect = hight_score_text.get_rect(center = (width // 2, 506))
        screen.blit(hight_score_text, high_score_rect)
...
clock = pygame.time.Clock()
clock = pygame.display.set_mode((width, height))
